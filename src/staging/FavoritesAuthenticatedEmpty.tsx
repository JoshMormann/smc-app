...
function FavoritesAuthenticatedEmpty() {
  return (
    <DefaultPageLayout>
            ...
            cards={
              <StylereferenceCard
                ...
                images={
                  <>
                    <img
                      className="hidden w-full grow shrink-0 basis-0 object-contain row-span-4 col-span-4 row-start-1"
...
export default FavoritesAuthenticatedEmpty;