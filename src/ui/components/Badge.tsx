...
/*
 * Documentation:
 * Badge — https://app.subframe.com/6b68d96d3e29/library?component=Badge_97bdb082-1124-4dd7-a335-b14b822d0157
 */
    ...
    return (
      <div
        className={SubframeUtils.twClassNames(
          "group/97bdb082 flex h-6 items-center gap-1 rounded-rounded-full border border-solid border-brand-primary-100 bg-brand-primary-100 px-2",
          {
      ...
      >
        {icon ? (
          <SubframeCore.IconWrapper
            className={SubframeUtils.twClassNames(
              "text-caption font-caption text-brand-primary-700",
              {
        ...
        {children ? (
          <span
            className={SubframeUtils.twClassNames(
              "whitespace-nowrap text-caption font-caption text-brand-primary-800",
              {
                "text-success-800": variant === "success",
                "text-warning-800": variant === "warning",
