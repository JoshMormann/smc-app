...
/*
 * Documentation:
 * Bold navbar mobile — https://app.subframe.com/6b68d96d3e29/library?component=Bold+navbar+mobile_f905f6bd-ab80-464d-a940-fcb91b9ddf42
  ...
  return (
    <div
      className={SubframeUtils.twClassNames(
        "group/0a1c836c flex h-8 cursor-pointer flex-col items-center justify-center gap-4 rounded-rounded-full px-4",
        { "bg-brand-primary-200": selected },
        className
      )}
      ref={ref}
      {...otherProps}
    >
      {children ? (
        <span className="font-['Montserrat'] text-[15px] font-[600] leading-[20px] text-brand-primary-900">
          {children}
        </span>
      ) : null}
    </div>
