...
/*
 * Documentation:
 * Breadcrumbs — https://app.subframe.com/6b68d96d3e29/library?component=Breadcrumbs_8898334b-a66f-4ee8-8bd1-afcfa8e37cc0
 */
...
interface ItemProps extends React.HTMLAttributes<HTMLSpanElement> {
  ...
  active?: boolean;
  variant?: "default";
  main?: "default" | "top-nav" | "top-nav-active-true";
  className?: string;
}
  ...
  return children ? (
    <span
      className={SubframeUtils.twClassNames(
        ...
        {
          "text-heading-2---light font-heading-2---light":
            main === "top-nav-active-true",
          "text-large-button font-large-button text-default-font flex lg:hidden xl:flex 2xl:flex sm:hidden md:hidden hover:text-subtext-color":
            main === "top-nav",
          "text-body-bold font-body-bold text-default-font": active,
        },
        className
      )}
      ref={ref}
