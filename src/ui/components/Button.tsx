    ...
    return (
      <button
        className={SubframeUtils.twClassNames(
          "group/3b777358 flex h-8 cursor-pointer items-center justify-center gap-2 rounded-md border-none bg-brand-primary-600 px-3 hover:bg-brand-primary-500 active:bg-brand-primary-600 disabled:cursor-default disabled:bg-neutral-200 hover:disabled:cursor-default hover:disabled:bg-neutral-200 active:disabled:cursor-default active:disabled:bg-neutral-200",
          {
            "h-7 w-auto flex-row flex-nowrap gap-1 px-3 py-0": size === "small",
            "h-11 w-auto px-4 py-0": size === "large",
            ...
            "bg-transparent hover:bg-brand-primary-50 active:bg-brand-primary-100":
              variant === "brand-tertiary",
            "bg-brand-primary-50 hover:bg-brand-primary-100 active:bg-brand-primary-50":
      ...
      >
          ...
          <SubframeCore.IconWrapper
            className={SubframeUtils.twClassNames(
              "text-body font-body text-white group-disabled/3b777358:text-neutral-400",
              {
                ...
                "text-heading-4 font-heading-4": size === "large",
        ...
        {children ? (
          <span
            className={SubframeUtils.twClassNames(
              "whitespace-nowrap text-button font-button text-white group-disabled/3b777358:text-neutral-400",
              {
                hidden: loading,
                "text-small-button-/-tag font-small-button-/-tag":
                  size === "small",
                "text-large-button font-large-button": size === "large",
                "text-white": variant === "inverse",
                "text-error-700":
                  variant === "destructive-tertiary" ||
                  variant === "destructive-secondary",
