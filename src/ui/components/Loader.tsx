...
/*
 * Documentation:
 * Loader — https://app.subframe.com/6b68d96d3e29/library?component=Loader_f2e570c8-e463-45c2-aae9-a960146bc5d5
 */
  ...
  return (
    <SubframeCore.Loader
      className={SubframeUtils.twClassNames(
        "group/f2e570c8 text-body font-body text-brand-primary-600",
        {
