      ...
      <SubframeCore.Progress.Indicator asChild={true} {...otherProps}>
        <div
          className={SubframeUtils.twClassNames(
            "flex h-2 w-full flex-col items-start gap-2 rounded-rounded-full bg-brand-primary-600",
            className
          )}
          ref={ref}
        />
  ...
  function ProgressRoot(
    ...
    return (
      <SubframeCore.Progress.Root asChild={true} value={value} {...otherProps}>
        <div
          className={SubframeUtils.twClassNames(
            "flex w-full flex-col items-start gap-2 overflow-hidden rounded-rounded-full bg-neutral-100",
            className
          )}
          ref={ref}
        >
