...
/*
 * Documentation:
 * Sidebar with sections — https://app.subframe.com/6b68d96d3e29/library?component=Sidebar+with+sections_f4047c8b-cfb4-4761-b9cf-fbcae8a9b9b5
 */
  ...
  return (
    <div
      className={SubframeUtils.twClassNames(
        "group/2713e17b flex w-full cursor-pointer items-center gap-2 rounded-rounded-full px-3 py-2 hover:bg-neutral-50 active:bg-neutral-100",
        {
          "bg-brand-primary-50 hover:bg-brand-primary-50 active:bg-brand-primary-100":
            selected,
        },
        className
      )}
    ...
    >
      {icon ? (
        <SubframeCore.IconWrapper
          className={SubframeUtils.twClassNames(
            "text-heading-4 font-heading-4 text-neutral-600",
            { "text-brand-primary-700": selected }
          )}
        >
          {icon}
        </SubframeCore.IconWrapper>
