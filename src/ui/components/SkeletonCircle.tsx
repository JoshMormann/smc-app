...
/*
 * Documentation:
 * Skeleton Circle — https://app.subframe.com/6b68d96d3e29/library?component=Skeleton+Circle_8b6e7a84-358f-4dc5-9de8-792a18fa9955
 */
  ...
  return (
    <SubframeCore.Skeleton
      className={SubframeUtils.twClassNames(
        "group/8b6e7a84 flex h-9 w-9 flex-col items-start gap-2 rounded-rounded-full bg-neutral-200",
