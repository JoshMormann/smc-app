...
/*
 * Documentation:
 * Slider — https://app.subframe.com/6b68d96d3e29/library?component=Slider_f4092874-0320-449e-a0c5-b435987c4cfb
 */
    ...
    <SubframeCore.Slider.Range asChild={true} {...otherProps}>
      <div
        className={SubframeUtils.twClassNames(
          "flex h-full flex-col items-start rounded-rounded-full bg-brand-primary-600",
          className
        )}
        ref={ref}
      />
...
const Thumb = React.forwardRef<HTMLDivElement, ThumbProps>(function Thumb(
  ...
  return (
    <SubframeCore.Slider.Thumb asChild={true} {...otherProps}>
      <div
        className={SubframeUtils.twClassNames(
          "flex h-5 w-5 items-center gap-2 rounded-rounded-full bg-brand-primary-600",
          className
        )}
        ref={ref}
      />
...
const Track = React.forwardRef<HTMLDivElement, TrackProps>(function Track(
  ...
  return (
    <SubframeCore.Slider.Track asChild={true} {...otherProps}>
      <div
        className={SubframeUtils.twClassNames(
          "flex h-1.5 w-full flex-col items-start gap-2 rounded-rounded-full bg-neutral-100",
          className
        )}
        ref={ref}
      >
