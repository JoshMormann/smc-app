...
/*
 * Documentation:
 * Stepper — https://app.subframe.com/6b68d96d3e29/library?component=Stepper_3c5d47dc-1b1a-45d9-b244-18422d7bfb56
 */
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={SubframeUtils.twClassNames(
            "flex h-7 w-7 flex-none flex-col items-center justify-center gap-2 rounded-rounded-full bg-neutral-100",
            {
