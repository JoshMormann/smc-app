...
/*
 * Documentation:
 * Tabs — https://app.subframe.com/6b68d96d3e29/library?component=Tabs_e1ad5091-8ad8-4319-b1f7-3e47f0256c20
 */
  ...
  return (
    <div
      className={SubframeUtils.twClassNames(
        ...
        {
          "border-b-2 border-solid border-brand-primary-600 px-2.5 pt-0.5 pb-px hover:border-b-2 hover:border-solid hover:border-brand-primary-600":
            active,
        },
        className
      )}
          ...
          className={SubframeUtils.twClassNames(
            "text-body font-body text-subtext-color group-hover/d5612535:text-default-font",
            {
              "text-neutral-400 group-hover/d5612535:text-neutral-400":
                disabled,
              "text-brand-primary-700 group-hover/d5612535:text-brand-primary-700":
                active,
            }
          )}
        >
