...
/*
 * Documentation:
 * Toast — https://app.subframe.com/6b68d96d3e29/library?component=Toast_2c7966c2-a95d-468a-83fe-bf196b95be7a
 */
      ...
      >
        {icon ? (
          <SubframeCore.IconWrapper
            className={SubframeUtils.twClassNames(
              "text-heading-4 font-heading-4 text-neutral-700",
              {
                "text-success-700": variant === "success",
                "text-error-700": variant === "error",
                "text-brand-primary-600": variant === "brand",
              }
            )}
          >
            {icon}
