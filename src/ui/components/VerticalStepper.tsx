...
/*
 * Documentation:
 * Vertical Stepper — https://app.subframe.com/6b68d96d3e29/library?component=Vertical+Stepper_bdc0291d-b5be-40c5-ae2f-527a868488b2
 */
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={SubframeUtils.twClassNames(
            "flex h-7 w-7 flex-none items-center justify-center overflow-hidden rounded-rounded-full bg-neutral-100",
            {
        ...
        >
          {stepNumber ? (
            <span
              className={SubframeUtils.twClassNames(
                ...
                {
                  "text-body-bold font-body-bold text-brand-primary-700":
                    variant === "active",
          ...
          <FeatherCheck
            className={SubframeUtils.twClassNames(
              "hidden text-heading-4 font-heading-4 text-default-font",
              { "inline-flex text-brand-primary-700": variant === "completed" }
            )}
          />
        </div>
        <div
