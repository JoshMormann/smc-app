 ...
 * Default Page Layout — https://app.subframe.com/6b68d96d3e29/library?component=Default+Page+Layout_a57b1c43-310a-493f-b807-8cc88e2452cf
...
>(function DefaultPageLayoutRoot(
  ...
  return (
    ...
    >
      <SidebarWithSections
        className="hidden mobile:hidden"
        header={
          <img
